    ...
    <footer id="footer">
        ...
        <!-- <div id="margin_remove" style="margin-bottom: 130px;">
            <div id="term_visibility" class=" copyright-text text-center"
                ...
                <p class="container-fluid terms_modal"
                    style="padding-top: 30px; padding-bottom: 20px; padding-left: 180px; padding-right: 180px; color: #909090; background: #F9F9F9">
                    It is permitted
                    to
                ...
                <img id="close" src="{{ asset('assets/images/close.svg') }}" alt="close"
                    style=" width: 20px; position: absolute; top: 30px; right: 150px; cursor: pointer;">
        ...
        <div id="agree_display"
            ...
            <p class="container text-center" style="padding-top: 20px; padding-bottom: 10px; color: #909090;">For
                all
                visitors to
