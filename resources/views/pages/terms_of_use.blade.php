...
<body>
   <section class="container-fluid bg-white py-3 py-lg-5 privacy">
        <div class="container py-md-3" >
            <div class="row">
                <div class="col-12 text-center">
                    <h3 class="title fw-bold">Privacy Policy for SabiMONI Financial Literacy Platform - Central Bank of Nigeria</h3>
                </div>
            </div>
        </div>
    </section> 
    <section class="container-fluid bg-light px-0 px-lg-3 py-3 py-lg-5 privacy">
        <div class="container py-md-3">
            <div class="row">
                <div class="col">
                    <div class="card border-0">
                        <div class="card-body p-md-5">
                            ...
                            <p>On the SabiMONI Financial Literacy portal, accessible from sabimoni.org.ng, one of our main priorities is the privacy
                                of our visitors. This Privacy Policy document contains types of information that is collected and recorded on the
                                SabiMONI Financial Literacy portal and how we use it.</p>
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
                                the information that they shared and/or collect on the SabiMONI Financial Literacy portal. This policy is not
                            ...
                            <p>The SabiMONI Financial Literacy portal follows a standard procedure of using log files. These files log visitors when
                                they visit websites. All hosting companies do this and a part of hosting services' analytics. The information
                                collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date
                                and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information
                                that is personally identifiable. The purpose of the information is for analyzing trends, administering the site,
                                tracking users' movement on the website, and gathering demographic information. </p>

                            {{-- <h2>Advertising Partners Privacy Policies</h2>

                            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of the SabiMONI Financial
                                Literacy portal.</p>

                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
                                their respective advertisements and links that appear on the SabiMONI Financial Literacy portal, which are sent
                                directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used
                                to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you
                                see on websites that you visit.</p>

                            <p>Note that the SabiMONI Financial Literacy Portal has no access to or control over these cookies that are used by
                                third-party advertisers.</p>

                            <h3>Third Party Privacy Policies</h3>

                            <p>The SabiMONI Financial Literacy Portal's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                            ...
                            <h3>General Data Protection Regulation (GDPR)/Nigeria Data Protection Regulation (NDPR) Data Protection Rights</h3>
                            ...
                            <p>The SabiMONI Financial Literacy portal does not knowingly collect any Personal Identifiable Information from children
                                under the age of 13. If you think that your child provided this kind of information on our website, we strongly
                                encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our
                                records.</p>
                        </div>
                    </div>
                </div>
